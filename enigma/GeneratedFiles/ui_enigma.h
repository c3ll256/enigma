...
public:
    ...
    void setupUi(QMainWindow *enigmaClass)
    {
        ...
        rbtnEncodeChoose->setGeometry(QRect(230, 80, 89, 21));
        ...
        rbtnDecodeChoose->setGeometry(QRect(220, 80, 89, 16));
        ...
        lineDecodeSaveNowAddress->setGeometry(QRect(340, 80, 211, 20));
        chkDecodeDebug = new QCheckBox(tabDecode);
        chkDecodeDebug->setObjectName(QStringLiteral("chkDecodeDebug"));
        chkDecodeDebug->setGeometry(QRect(20, 320, 121, 16));
